...
\end{eqnarray*}
と置く. cosとsinの内積を計算すると, 
\begin{eqnarray*}
  \Braket{\cos{x}, \cos{x}} &=& \int_0^{2\pi}\cos^2{x}dx = \int_0^{2\pi}\frac{1+\cos{2x}}{2}dx \\
  &=& \frac{1}{2}\left[x + \frac{1}{2}\sin{2x}\right]_0^{2\pi}
  = \frac{1}{2}\left(2\pi + 0\right) = \pi
\end{eqnarray*}
\begin{eqnarray*}
  
  \Braket{\sin{x}, \sin{x}} &=& \int_0^{2\pi}\sin^2{x}dx = \int_0^{2\pi}\frac{1-\cos{2x}}{2}dx \\
  &=& \frac{1}{2}\left[x - \frac{1}{2}\sin{2x}\right]_0^{2\pi}
  = \frac{1}{2}\left(2\pi - 0\right) = \pi \\
\end{eqnarray*}
\begin{eqnarray*}

  \Braket{\cos{x}, \sin{x}} &=& \int_0^{2\pi}\cos{x}\sin{x}dx
...
\begin{eqnarray*}
  ...
  \Braket{\sin{x}, \cos{x}} &=& \int_0^{2\pi}\sin{x}\cos{x}dx = 0
\end{eqnarray*}
