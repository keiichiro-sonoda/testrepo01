...
code01.exe: code01.c
	gcc code01.c -o code01.exe -finput-charset=UTF-8 -fexec-charset=CP932
bubble_sort.exe: bubble_sort.c
	gcc bubble_sort.c -o bubble_sort.exe -finput-charset=UTF-8 -fexec-charset=CP932